...
class MemberAccountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields =['user','sponser_id','member_id','pin_code' ]
    ...
    def create(self, validated_data):
            ...
            # ActiveTalukaDistibuter.objects.create( distributer=member_account,is_active = active_taluka['is_active'])
            # ActiveDistrictDistibuter.objects.create( distributer=member_account,is_active = active_district['is_active'])
