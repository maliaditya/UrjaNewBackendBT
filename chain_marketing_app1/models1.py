...
class MemberAccount(models.Model):
    ...
    # is_city_distributer = models.BooleanField(default=False)
    # is_taluka_distributer = models.BooleanField(default=False)
    # is_dictrict_distributer = models.BooleanField(default=False)
