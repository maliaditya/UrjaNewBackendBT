...
,ActiveCityDistibuter,Introducer, City, Taluka, District,AdminAccounts,BankDetails,SubProductsStock)
...
class ActiveSellerAdmin(admin.ModelAdmin):
    list_display = ('seller','is_active' ,'bonus_points','subproduct_bonus_points','created_at','updated_at')
