...
from chain_marketing_app.views.binary_tree_downline import GetBinaryTreeHeirachy
from chain_marketing_app.views.binary_cycle_payouts import BinaryCyclePayouts
from django.urls import path
from django.urls import include
from .views.active import AcitveSellerViewset
from chain_marketing_app.views.fill_level_members import GetAllHeirachy
...
router.register('bt-downline', GetBinaryTreeHeirachy)
router.register('bt-payouts', BinaryCyclePayouts)
router.register('alllevels', GetAllHeirachy)
...
router.register('bt-members',BinaryTreeViewset)
